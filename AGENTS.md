...
This project is indexed by GitNexus as **credimi** (35548 symbols, 57673 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/credimi/context` | Codebase overview, check index freshness |
| `gitnexus://repo/credimi/clusters` | All functional areas |
| `gitnexus://repo/credimi/processes` | All execution flows |
| `gitnexus://repo/credimi/process/{name}` | Step-by-step execution trace |
