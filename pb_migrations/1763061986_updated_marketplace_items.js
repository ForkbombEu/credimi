...
migrate((app) => {
  ...
  // remove field
  collection.fields.removeById("_clone_FwGH")

  // remove field
  collection.fields.removeById("_clone_rt3s")
  ...
  // remove field
  collection.fields.removeById("_clone_qHJe")

  // remove field
  collection.fields.removeById("_clone_RXTr")
