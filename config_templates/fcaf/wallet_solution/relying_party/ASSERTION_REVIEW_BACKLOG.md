...
- [x] `WS_RP_SM_SessionEncryption__002` (verifier JWK published without `alg`; Wallet refuses with `invalid_request`)
- [x] `WS_RP_SM_SessionEncryption__003` (verifier JWK `alg` cannot be the JWE `alg`; Wallet refuses with `invalid_request`)
