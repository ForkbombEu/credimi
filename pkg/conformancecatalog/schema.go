...
// Shared SQLite column types for catalog columns.
const (
	sqlTextNotNull             = "TEXT NOT NULL"
	sqlTextNotNullDefaultEmpty = "TEXT NOT NULL DEFAULT ''"
)
...
var checkColumns = []columnSpec{
	...
	{Name: "path", SQLType: sqlTextNotNull, Client: true, Kind: ColumnKindString},
	{Name: "title", SQLType: sqlTextNotNull, Client: true, Kind: ColumnKindString},
	{Name: "fs_standard", SQLType: sqlTextNotNull, Client: true, Kind: ColumnKindString},
	{Name: "fs_version", SQLType: sqlTextNotNull, Client: true, Kind: ColumnKindString},
	{Name: "suite", SQLType: sqlTextNotNull, Client: true, Kind: ColumnKindString},
	{Name: "file", SQLType: sqlTextNotNull, Client: true, Kind: ColumnKindString},
	{
		Name:     "visible_in",
		SQLType:  "TEXT NOT NULL DEFAULT '[]'",
		Client:   true,
		Kind:     ColumnKindStringArray,
		Optional: true,
		Default:  "[]",
	},
	{
		Name:     "protocol",
		SQLType:  sqlTextNotNullDefaultEmpty,
		Client:   true,
	...
	{Name: "created", SQLType: sqlTextNotNullDefaultEmpty, Client: false, Kind: ColumnKindString},
	{Name: "updated", SQLType: sqlTextNotNullDefaultEmpty, Client: false, Kind: ColumnKindString},
}

// suiteColumns defines conformance_suites ephemeral + list/get wire fields.
var suiteColumns = []columnSpec{
	{Name: "id", SQLType: "TEXT PRIMARY KEY NOT NULL", Client: true, Kind: ColumnKindString},
	{Name: "standard", SQLType: sqlTextNotNull, Client: true, Kind: ColumnKindString},
	{
		Name:     "component",
		SQLType:  sqlTextNotNullDefaultEmpty,
		Client:   true,
	...
	{
		Name:     "component_rank",
		SQLType:  "INTEGER NOT NULL DEFAULT 9",
		Client:   true,
		Kind:     ColumnKindNonNegInt,
		Optional: true,
		Default:  "9",
	},
	{
	...
	{Name: "fs_version", SQLType: sqlTextNotNullDefaultEmpty, Client: true, Kind: ColumnKindString},
	{Name: "path_prefix", SQLType: sqlTextNotNull, Client: true, Kind: ColumnKindString},
	{Name: "created", SQLType: sqlTextNotNullDefaultEmpty, Client: false, Kind: ColumnKindString},
	{Name: "updated", SQLType: sqlTextNotNullDefaultEmpty, Client: false, Kind: ColumnKindString},
}
