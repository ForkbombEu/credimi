		...
		Routes: []routing.RouteDefinition{
			{
				...
				RequestResponse: handlers.ListMyChecksRequestResponse{},
			...
			},
			{
				...
				RequestResponse: handlers.ListMyCheckRunsRequestResponse{},
			...
			},
			{
				...
				RequestResponse: handlers.GetMyCheckRunRequestResponse{},
			...
			},
			{
				...
				RequestResponse: handlers.GetMyCheckRunHistory{},
			...
			},
			{
				...
				Request:         handlers.ReRunCheckRequest{},
				RequestResponse: handlers.ReRunCheckRequestResponse{},
			...
			},
			{
				...
				RequestResponse: handlers.CancelMyCheckRunRequestResponse{},
			...
			},
			{
				...
				RequestResponse: handlers.ExportMyCheckRun{},
			...
			},
			{
				...
				RequestResponse: handlers.ChecksLogsRequestResponse{},
			...
			},
			{
				...
				RequestResponse: handlers.TerminateMyCheckRunRequestResponse{},
	...
	routing.AddGroupRoutes(app, routing.RouteGroup{
		...
		Routes: []routing.RouteDefinition{
			...
			},
			{
				...
				Request: handlers.SaveVariablesAndStartRequestInput{},
			},
			{
				Method:  http.MethodPost,
				Path:    "/notify-failure",
				Handler: handlers.HandleNotifyFailure,
				Request: handlers.HandleNotifyFailureRequestInput{},
			},
			{
				Method:  http.MethodPost,
				Path:    "/confirm-success",
				Handler: handlers.HandleConfirmSuccess,
				Request: handlers.HandleConfirmSuccessRequestInput{},
			},
			{
				Method:  http.MethodPost,
				Path:    "/send-temporal-signal",
				Handler: handlers.HandleSendTemporalSignal,
				Request: handlers.HandleSendTemporalSignalInput{},
			},
			{
				Method:              http.MethodPost,
				Path:                "/send-log-update",
				Handler:             handlers.HandleSendLogUpdate,
				Request:             handlers.HandleSendLogUpdateRequestInput{},
