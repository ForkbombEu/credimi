...
func DefaultRegistry() (*Registry, error) {
	return NewRegistry(
		...
		JOSEJWSInvalidSignatureValidator{},
		...
		OID4VPRequestEncryptionJWKValidator{},
		...
		OID4VPDCQLArraySelectorFilterValidator{},
		OID4VPDCQLObjectPropertyFilterValidator{},
		OID4VPDCQLRequestedClaimPathsValidator{},
		MDocMSOStatusMemberPresentValidator{},
		MDocMSOStatusCBORTypeValidator{},
		MDocMSOStatusURIValidator{},
		...
		SDJWTKBJWTClaimStringPrefixValidator{},
