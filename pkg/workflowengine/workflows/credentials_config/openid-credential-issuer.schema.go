...
type OpenidCredentialIssuerSchemaJsonCredentialConfigurationsSupported map[string]struct {
	...
	CryptographicBindingMethodsSupported []interface{} `json:"cryptographic_binding_methods_supported,omitempty" yaml:"cryptographic_binding_methods_supported,omitempty" mapstructure:"cryptographic_binding_methods_supported,omitempty"`
...
type OpenidCredentialIssuerSchemaJsonCredentialConfigurationsSupportedValueCryptographicBindingMethodsSupportedElem_1 string

const OpenidCredentialIssuerSchemaJsonCredentialConfigurationsSupportedValueCryptographicBindingMethodsSupportedElem_1_CoseKey OpenidCredentialIssuerSchemaJsonCredentialConfigurationsSupportedValueCryptographicBindingMethodsSupportedElem_1 = "cose_key"
const OpenidCredentialIssuerSchemaJsonCredentialConfigurationsSupportedValueCryptographicBindingMethodsSupportedElem_1_JWK OpenidCredentialIssuerSchemaJsonCredentialConfigurationsSupportedValueCryptographicBindingMethodsSupportedElem_1 = "JWK"
const OpenidCredentialIssuerSchemaJsonCredentialConfigurationsSupportedValueCryptographicBindingMethodsSupportedElem_1_Jwk OpenidCredentialIssuerSchemaJsonCredentialConfigurationsSupportedValueCryptographicBindingMethodsSupportedElem_1 = "jwk"

var enumValues_OpenidCredentialIssuerSchemaJsonCredentialConfigurationsSupportedValueCryptographicBindingMethodsSupportedElem_1 = []interface{}{
	"jwk",
	"JWK",
	"cose_key",
}
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *OpenidCredentialIssuerSchemaJsonCredentialConfigurationsSupportedValueCryptographicBindingMethodsSupportedElem_1) UnmarshalJSON(value []byte) error {
	var v string
	if err := json.Unmarshal(value, &v); err != nil {
		return err
	}
	var ok bool
	for _, expected := range enumValues_OpenidCredentialIssuerSchemaJsonCredentialConfigurationsSupportedValueCryptographicBindingMethodsSupportedElem_1 {
		if reflect.DeepEqual(v, expected) {
			ok = true
			break
		}
	...
	if !ok {
		return fmt.Errorf("invalid value (expected one of %#v): %#v", enumValues_OpenidCredentialIssuerSchemaJsonCredentialConfigurationsSupportedValueCryptographicBindingMethodsSupportedElem_1, v)
	}
	*j = OpenidCredentialIssuerSchemaJsonCredentialConfigurationsSupportedValueCryptographicBindingMethodsSupportedElem_1(v)
	return nil
}
...
const OpenidCredentialIssuerSchemaJsonCredentialConfigurationsSupportedValueProofTypesSupportedValueProofSigningAlgValuesSupportedElemES384 OpenidCredentialIssuerSchemaJsonCredentialConfigurationsSupportedValueProofTypesSupportedValueProofSigningAlgValuesSupportedElem = "ES384"
