...
//go:generate go run github.com/atombender/go-jsonschema@v0.18.0 -p credentials_config ../schemas/credentialissuer/openid-credential-issuer.schema.json -o workflowengine/workflows/credentials_config/openid-credential-issuer.schema.go
