...
//go:generate go run ../cmd/template/template.go -d ../schemas/ewc/default_template.yaml -i ../schemas/ewc/openid4vci_wallet_1.0/checks.json -o ../config_templates/openid4vci_wallet/1.0/ewc/
//go:generate go run ../cmd/template/template.go -d ../schemas/ewc/default_template.yaml -i ../schemas/ewc/openid4vp_wallet_1.0/checks.json -o ../config_templates/openid4vp_wallet/1.0/ewc/
