...
//go:generate go run ../cmd/template/template.go -d ../schemas/webuild/openid4vci_issuer_1.0/default_template.yaml -i ../schemas/webuild/openid4vci_issuer_1.0/checks.json -o ../config_templates/openid4vci_issuer/1.0/webuild/
//go:generate go run ../cmd/template/template.go -d ../schemas/webuild/openid4vp_verifier_1.0/default_template.yaml -i ../schemas/webuild/openid4vp_verifier_1.0/checks.json -o ../config_templates/openid4vp_verifier/1.0/webuild/
...
//go:generate go generate ./conformancecatalog
