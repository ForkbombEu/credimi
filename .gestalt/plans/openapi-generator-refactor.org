...
* DONE [#A] Confirm Scope, Constraints, and Success Criteria
Effort: S
...
* DONE [#A] Baseline Current Generator Behavior
Effort: S
...
* DONE [#A] Remove TypeScript Client Generation (Generator-Only)
Effort: S
...
* DONE [#A] Implement OpenAPI YAML Generation via `swaggest/openapi-go`
Effort: M
...
* DONE [#B] Emit YAML to `docs/public/API/openapi.yml` (Stable Output)
Effort: S
...
* DONE [#B] Validation, Regression Checks, and Module Hygiene
Effort: M
...
** DONE [#B] Run generator and compare against baseline
...
** DONE [#B] Update Go module dependencies safely
