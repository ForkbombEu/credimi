...
* WIP [#A] Eliminate false “Failed to poll queue” toast after canceling a queued run
- Effort :: S
...
** WIP [#B] Stop queue polling immediately on cancel and treat `not_found` as success during cancel
