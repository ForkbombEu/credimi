...
description: Create a Credimi account and configure the organization used to publish solutions.
---
...
![Create account](../images/credimiCreateAccount.png)
...
![Organization editor](../images/credimiOrganizationEdit.png)
