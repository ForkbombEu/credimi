...
description: User-facing guide to the Hub, conformance and interoperability testing, publishing integrations, and testing automation.
---

Credimi has four main user-facing areas:

1. **Hub** — anyone can explore components and solutions and try issuance or verification services.
...
3. **Publish to Hub** — solution developers can list Wallets, Issuers and Verifiers, then integrate issuers and verifiers with StepCI so visitors can try them from credimi.io.
...
- Reuse Hub integrations later in manual tests and pipelines

###

![Hub issuers](./manual/images/hub-issuers-list1.png)
