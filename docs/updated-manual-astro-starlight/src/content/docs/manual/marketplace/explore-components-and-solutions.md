...
> Placeholder: later add a short section on how to distinguish metadata-only listings from listings that expose a live issuance or verification integration.
