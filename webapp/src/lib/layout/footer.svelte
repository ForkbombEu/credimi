...
<script lang="ts">
	...
	const footer_data = [
		{
			...
			links: [
				...
				{ label: m.Conformance_automation(), url: 'https://docs.credimi.io/Manual/compliance-checks.html' },
				{ label: m.api_documentation(), url: 'https://docs.credimi.io/API/index.html' },
				{ label: m.platform_architecture(), url: 'https://docs.credimi.io/Software_Architecture/1_start.html' },
				{ label: m.deployment_options(), url: 'https://docs.credimi.io/Software_Architecture/7_dev_setup.html' }
	...
	*/
				{ label: m.identity_wallet_integration(), url: 'https://docs.credimi.io/Manual/compliance-checks.html' },
				{ label: m.conformance_compliance_tools(), url: 'https://docs.credimi.io/Software_Architecture/Workflow_YAML.html' },
				{ label: m.ecosystem_governance(), url: 'https://docs.credimi.io/Manual/browse-marketplace.html' }
			]
		},
		{
			label: m.Developers(),
	...
	//			{ label: m.sandbox_environment(), url: '/developers/sandbox' },
				{ label: m.test_suites_runs(), url: 'https://docs.credimi.io/Manual/compliance-checks.html' },
				{ label: m.developer_tools(), url: 'https://docs.credimi.io/Software_Architecture/Workflow_YAML.html' },
	...
	//			{ label: m.security(), url: '/security' },
				...
				{ label: m.legal_privacy(), url: 'https://docs.credimi.io/Legal/privacy-policy.html' },
				{ label: m.terms_and_conditions(), url: 'https://docs.credimi.io/Legal/terms-and-conditions.html' }
			]
		}
	];
</script>
