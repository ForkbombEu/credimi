...
export class CredimiClient {
     ...
     */
    async generateApiKey(input: GenerateApiKeyRequestSchema): Promise<GenerateApiKeyResponseSchema> {
     ...
     */
    async authenticateApiKey(): Promise<AuthenticateApiKeyResponseSchema> {
