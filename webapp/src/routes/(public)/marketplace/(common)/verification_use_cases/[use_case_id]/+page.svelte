...
<MarketplacePageLayout tableOfContents={sections}>
	...
	<div>
		<PageHeader title={sections.related_verifier.label} id={sections.related_verifier.anchor} />
		<MarketplaceItemCard item={data.verifierMarketplaceItem} class="max-w-[400px]" />
	</div>
